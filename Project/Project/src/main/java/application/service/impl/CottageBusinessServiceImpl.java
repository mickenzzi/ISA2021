...
@Service
public class CottageBusinessServiceImpl implements CottageBusinessService{

	@Autowired
	private CottageService cottageService;
	@Autowired
	private TerminCottageService terminService;
	...
	public Double getOwnerProfit(String startDate, String endDate, Long id) throws ParseException {
		...
		for(TerminCottage t : cottageTermins) {
	...
	public Integer countReservationDays(TerminCottage termin) throws ParseException {
