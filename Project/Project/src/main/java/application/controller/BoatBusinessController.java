...
@RestController
@RequestMapping(value = "/api/boatBusiness")
public class BoatBusinessController {

	@Autowired
	private BoatBusinessService businessService;
	...
	@GetMapping(value = "/boatProfit/{id}/{start}/{end}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatReservationsPerMonth/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatReservationsPerWeek/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatReservationsPerDay/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatReservedDaysPerMonth/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatReservedDaysPerWeek/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatReservedDays/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatMonthlyProfit/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatWeeklyProfit/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
	...
	@GetMapping(value = "/boatDailyProfit/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	@PreAuthorize("hasRole('BOAT_OWNER')")
